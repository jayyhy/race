...
<body onbeforeunload="getVideoTime()">
    ...
    <img src="<?php echo IMG_URL_NEW; ?>icon_video.png" style="position: relative;top: 31px;"/><h2 style="position: relative;left:38px;top: -18px;width: 300px"><?php echo $race['raceName'];?></h2>
