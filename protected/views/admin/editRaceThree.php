...
<div class="span9">
    ...
    <div>
        ...
        <h3></h3>
        <form class="form-horizontal" method="post" action="./index.php?r=admin/editRace&indexID=<?php echo $_GET['indexID']; ?>&step=3" id="myForm" enctype="multipart/form-data"> 
    ...
    $(document).ready(function () {
        ...
        if (result === '1')
            window.wxc.xcConfirm("操作成功！", window.wxc.xcConfirm.typeEnum.success, {
                onOk: function () {
                    window.location.href = "./index.php?r=admin/editRace&indexID=<?php echo $_GET['indexID']; ?>&step=4";
                }
            });
        else if (result === '0') {
