<div class="span3">
    <div class="well" style="padding: 8px 0;">
        <ul class="nav nav-list">
            ...
            <li class="divider"></li>
            <li class="active" ><a href="./index.php?r=admin/raceLst"><i class="icon-align-left"></i> 试卷列表</a></li>
        </ul>
    </div>
</div>
<div class="span9">
    ...
    <table class="table table-bordered table-striped">
        ...
        <tbody>        
        <form id="deleForm" method="post" action="./index.php?r=admin/deleteRaceIndex">
            <?php foreach ($raceLst as $k => $model): ?>
                <tr>
                    ...
                    <td class="font-center" style="width: 100px">  
                        <a href="./index.php?r=admin/editRace&indexID=<?php echo $model['indexID']; ?>&step=1"  ><img title="编辑" src="<?php echo IMG_URL; ?>edit.png"></a>
...
<script>
    ...
    function deleteRaceIndex(id, name) {
        var option = {
            ...
            btn: parseInt("0011", 2),
            onOk: function () {
                window.location.href = "./index.php?r=admin/deleteRaceIndex&&indexID=" + id;
            }
        };
    ...
    function addRace() {
        ...
        if(courseName!==""){
            window.location.href="./index.php?r=admin/addRaceIndex&raceName="+courseName;
        }else{
