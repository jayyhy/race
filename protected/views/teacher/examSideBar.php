    ...
    <?php foreach ($raceIndex as $k => $model): ?>
     <div style="margin-top: 15px;background:#F8F4F2;width: 210px;height: 88px;border-radius: 6px;" >
        <div style="margin-left: 10px;padding-top: 15px;">
            <a href="#" onclick="getExam(<?php echo $model['indexID']; ?>)"><font style="font-size:16px; font-weight: 600;color: #E35C43"><?php echo "0".$model['indexID']; ?>&nbsp;&nbsp;&nbsp;</font><font style="font-size:16px; font-weight: 600;color: #3A393E"><?php echo $model['name']; ?></font></a>
        </div>
